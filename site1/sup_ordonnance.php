...
$var = $_GET['id'];
  $deleteSQL = sprintf("DELETE FROM ordonnance WHERE id_ord like ".$var);
...
<html lang="en">
<head>
	<title>supprimer ordinnance</title>
	<meta charset="utf-8">
	...
	<section id="content"><div class="ic">More Website Templates @ TemplateMonster.com - Mrach 03, 2012!</div>
		<div class="main">
			<div class="container_12">
				<div class="wrapper">
				  <div class="aligncenter"><strong>supprimer une ordonnance</strong></div>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
				  <p><strong> Votre ordonnance a eté supprimé avec succes</strong></p>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
				</div>
