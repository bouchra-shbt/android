...
$var = $_GET['id'];
  ...
  $deleteSQL = sprintf("DELETE FROM doses WHERE id_ord like ".$var);
	...
	<section id="content"><div class="ic">More Website Templates @ TemplateMonster.com - Mrach 03, 2012!</div>
		<div class="main">
			<div class="container_12">
				<div class="wrapper">
				  <div class="aligncenter"><strong>supprimer une dose</strong></div>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
				  <p><strong> Votre dose a eté supprimé avec succes</strong></p>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
				</div>
