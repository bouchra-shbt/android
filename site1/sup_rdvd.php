...
$var = $_GET['id'];
  ...
  $deleteSQL = sprintf("DELETE FROM rdvd WHERE id_rdvd like ".$var);
	...
	<section id="content"><div class="ic">More Website Templates @ TemplateMonster.com - Mrach 03, 2012!</div>
		<div class="main">
			<div class="container_12">
				<div class="wrapper">
				  <div class="aligncenter"><strong>Supprimer RDV demandé</strong></div>
				  <p>&nbsp;</p>
				  <p><strong>le RDV demandé a été supprimé</strong><strong>.</strong></p>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
