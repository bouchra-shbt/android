...
$var = $_GET['id'];
  $deleteSQL = sprintf("DELETE FROM admin WHERE id_admin like ".$var); 
	...
	<section id="content"><div class="ic">More Website Templates @ TemplateMonster.com - Mrach 03, 2012!</div>
		<div class="main">
			<div class="container_12">
				<div class="wrapper">
				  <div class="aligncenter"><strong>supprimer admin</strong></div>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
				  <p><strong> Votre admin a eté supprimé avec succes</strong></p>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
				</div>
		  </div>
