...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO ordonnance (id_ord, tc, n_vi) VALUES (NULL, %s, %s)",
			...
			<div class="container_12">
				<div class="wrapper">
				  <div class="aligncenter">
				    <div align="center"><strong> Ajouter Ordonnance</strong></div>
				  </div>
				  <p align="center">&nbsp;</p>
                    ...
                    <div align="center">
                      <table align="center">
                        <tr valign="baseline">
                          ...
                          <td><input type="text" name="tc" value="" size="32"></td>
                        </tr>
                        <tr valign="baseline">
