...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE ordonnance SET tc=%s, n_vi=%s WHERE id_ord like ".$var,
                       GetSQLValueString($_POST['tc'], "text"),
...
mysql_select_db($database_conn, $conn);
$query_ordonnance = "SELECT * FROM ordonnance where id_ord like ".$var;
$ordonnance = mysql_query($query_ordonnance, $conn) or die(mysql_error());
$row_ordonnance = mysql_fetch_assoc($ordonnance);
$totalRows_ordonnance = mysql_num_rows($ordonnance);
?><!DOCTYPE html>
<html lang="en">
<head>
	<title>maj ordonnance</title>
	<meta charset="utf-8">
			...
			<div class="container_12">
				<div class="wrapper">
				  <div class="aligncenter">
				    <div align="center"><strong>mise a jour ordonnance</strong></div>
				  </div>
				  <p align="center">&nbsp;</p>
				  <p align="center">&nbsp;</p>
                  ...
                  <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                    <div align="center">
                      <table align="center">
                        <tr valign="baseline">
                          <td nowrap align="right">Type de consultation:</td>
                          <td><input type="text" name="tc" value="<?php echo htmlentities($row_ordonnance['tc'], ENT_COMPAT, ''); ?>" size="32"></td>
                        </tr>
                        <tr valign="baseline">
                          <td nowrap align="right">Num visite:</td>
                          <td><label>
...
?>
                      ...
                      <input type="hidden" name="id_ord" value="<?php echo $row_ordonnance['id_ord']; ?>">
                      </div>
                  </form>
                  <p align="center">&nbsp;</p>
                  <p align="center">&nbsp;</p>
