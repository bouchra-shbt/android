...
$query_requette = "select * from patient,fiche_visite,certificat where patient.id_patient=fiche_visite.id_patient and fiche_visite.n_vi=certificat.n_vi and concat(id_cer,nom_patient) like   \"%$var%\"  ";
			...
			<div class="container_12">
				<div class="wrapper">
				  <div class="aligncenter">
				    <p align="center"><strong> recherchre certificat</strong></p>
				    <form name="form1" method="get" action="rech_cer.php">
                      <p>&nbsp;</p>
                      <p>&nbsp;</p>
                      <table width="509" border="1">
                        <tr>
                          <td width="244">entrez N° de certificat ou nom patient</td>
<td width="150"><label>
				  ...
				  <table border="1">
                    <tr>
                      <td width="857"><p align="center">&nbsp;</p>
                        <p align="center"><span class="Style2">information:</span></p>
                        ...
                        <p><strong>Num de fiche visite:</strong><?php echo $row_requette['n_vi']; ?></p>
                        <p><strong>N de certificat:</strong><?php echo $row_requette['id_cer']; ?></p>
                      <p><strong>Date de debut:</strong><?php echo $row_requette['date_debut']; ?><strong>date de fin:</strong><?php echo $row_requette['date_fin']; ?> </p>
