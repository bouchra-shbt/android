	...
	<section id="content"><div class="ic">More Website Templates @ TemplateMonster.com - Mrach 03, 2012!</div>
		<div class="main">
			<div class="container_12">
				<div class="wrapper">
				  <div class="aligncenter"><strong>LOGIN medecin</strong></div>
				  <p>&nbsp;</p>
				  <form name="form1" method="get" action="login_medecin.php">
...
$query = " select * from medecin where  motpasse_medecin like \"$trimmedd\"  and email_medecin like \"$trimmed\"   "; 
...
Redirect($Str_Location = "acc_medecin.php", $Bln_Replace = 1, $Int_HRC = NULL);
   }}
       ?></div></td>
                      </tr>
                      <tr>
