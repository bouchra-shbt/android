...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO rdv (n_rdv, date_rdv, heure_rdv, obs, id_patient, id_medecin) VALUES (NULL, %s, %s, %s, %s, %s)",
			...
			<div class="container_12">
				<div class="wrapper">
				  <div class="aligncenter">
				    <div align="center"><strong>Ajouter un  RDV</strong></div>
				  </div>
				  <p align="center">&nbsp;</p>
				  <p align="center">&nbsp;</p>
                    ...
                    <div align="center">
                      <table align="center">
                        <tr valign="baseline">
                          ...
                          <input type="text" name="date_rdv" value="" size="32">
                        ...
                        <tr valign="baseline">
                          ...
                          <input type="text" name="heure_rdv" value="" size="32">
                          <span class="textfieldRequiredMsg">Une valeur est requise.</span><span class="textfieldInvalidFormatMsg">Format non valide.</span></span></td>
                        </tr>
                        <tr valign="baseline">
                          <td nowrap align="right">Observation :</td>
                          <td><input type="text" name="obs" value="" size="32"></td>
                        </tr>
                        <tr valign="baseline">
