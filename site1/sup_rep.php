...
$var = $_GET['id'];
  ...
  $deleteSQL = sprintf("DELETE FROM rep WHERE id_rep like ".$var);
	...
	<section id="content"><div class="ic">More Website Templates @ TemplateMonster.com - Mrach 03, 2012!</div>
		<div class="main">
			<div class="container_12">
				<div class="wrapper">
				  <div class="aligncenter"><strong>suppression d'une reponse</strong></div>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
				  <p align="center"><strong>Reponse supprimée.</strong></p>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
				</div>
