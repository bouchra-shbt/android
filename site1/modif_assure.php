...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE assure SET tpc=%s, date_f_d=%s WHERE nass like ".$var,
...
mysql_select_db($database_conn, $conn);
$query_assure = "SELECT * FROM assure where nass like ".$var;
			...
			<div class="container_12">
				<div class="wrapper">
				  <div class="aligncenter">
				    <div align="center"><strong>mise à jour assure</strong></div>
				  </div>
				  <p align="center">&nbsp;</p>
				  <p align="center">&nbsp;</p>
				  <p align="center">&nbsp;</p>
				  <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                    <div align="center">
                      <table align="center">
                        <tr valign="baseline">
                          <td nowrap align="right">N assuré:</td>
                          <td><?php echo $row_assure['nass']; ?></td>
                        </tr>
                        <tr valign="baseline">
                          <td nowrap align="right">Taux de prise en charge:</td>
                          <td><input type="text" name="tpc" value="<?php echo htmlentities($row_assure['tpc'], ENT_COMPAT, ''); ?>" size="32"></td>
                        </tr>
                        <tr valign="baseline">
                          <td nowrap align="right">Date de prise en charge:</td>
                          <td><span id="sprytextfield1">
                          <input type="text" name="date_f_d" value="<?php echo htmlentities($row_assure['date_f_d'], ENT_COMPAT, ''); ?>" size="32">
                      ...
                      <input type="hidden" name="nass" value="<?php echo $row_assure['nass']; ?>">
                      </div>
                  </form>
                  <p align="center">&nbsp;</p>
                  <p align="center">&nbsp;</p>
