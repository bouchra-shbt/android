...
$var = $_GET['n'];
  ...
  $deleteSQL = sprintf("DELETE FROM medicament WHERE n_med like ".$var);
...
<html lang="en">
<head>
	<title>supprimer medicament</title>
	<meta charset="utf-8">
	...
	<section id="content"><div class="ic">More Website Templates @ TemplateMonster.com - Mrach 03, 2012!</div>
		<div class="main">
			<div class="container_12">
				<div class="wrapper">
				  <div class="aligncenter"><strong>supprimer medicament</strong></div>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
				  <p><strong> Votre medicament a eté supprimé avec succes</strong></p>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
				</div>
		  </div>
