...
$query_requette = "select * from patient where concat(id_patient,nom_patient) like   \"%$var%\"  ";
			...
			<div class="container_12">
				<div class="wrapper">
				  <div class="aligncenter">
				    <p align="center"><strong>Rechercher patient</strong></p>
				    <form name="form1" method="get" action="rech_patient.php">
                      <table width="508" border="1">
                        <tr>
                          <td width="216"><p>entrez N°  ou nom du patient</p>
                          </td>
                    <td width="193"><label>
				  ...
				  <table width="714" height="701" border="1">
                    
              <?php do { ?>
                      <tr>
                        <td width="618"><p>&nbsp;</p>
                          <p align="center" class="Style1">Informations patient:</p>
                        ...
                        <p><strong>Mot de passe patient:</strong><?php echo $row_requette['motpasse_patient']; ?></p></td>
                    </tr>
