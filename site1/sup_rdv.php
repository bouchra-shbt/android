...
$var = $_GET['n'];
  $deleteSQL = sprintf("DELETE FROM rdv WHERE n_rdv like ".$var);
	...
	<section id="content"><div class="ic">More Website Templates @ TemplateMonster.com - Mrach 03, 2012!</div>
		<div class="main">
			<div class="container_12">
				<div class="wrapper">
				  <div class="aligncenter"><strong>supprimer RDV</strong></div>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
				  <p align="center"><strong>      Votre RDV a eté supprimé avec succes</strong></p>
				  <p>&nbsp;</p>
				  <p>&nbsp;</p>
				</div>
		  </div>
